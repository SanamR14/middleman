...
const Products = ({product }) => {
  ...
  return (
    <Card style={styles.root}>
        <CardMedia style={styles.media} image={product.image} title={product.name} />
        <CardContent >
        ...
        <CardActions disableSpacing style={styles.CardActions}>
            <Button varient="text" style={{flexGrow:1, justifyContent:"flex-start"}}>{product.businessName}</Button>
